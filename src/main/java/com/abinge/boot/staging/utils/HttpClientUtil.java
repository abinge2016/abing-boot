...
public class HttpClientUtil {
    ...
    public static CloseableHttpResponse doPostFormAndGetCookies(String url, Map<String, String> parameters, String contentType, CookieStore httpCookieStore) {
    ...
    public static String doPostFormWithCookie(String url, Map<String, String> parameters, CookieStore httpCookieStore) {
        HttpPost httpPost = new HttpPost(url);
    ...
    public static String doPostJsonWithCookie(String url, String paramJson, CookieStore httpCookieStore) {
        HttpPost httpPost = new HttpPost(url);
    ...
    public static String doGetWithCookie(String url, String contentType, CookieStore httpCookieStore) {
